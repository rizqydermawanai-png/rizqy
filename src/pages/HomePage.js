...
import {
    IconShirt, IconUsers, IconGooglePlay, IconApple
} from '../icons';
        ...
        <div className="container mx-auto px-5">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link to="/special-collections" className="btn bg-[#6D4C41] hover:bg-[#4E342E]">Explore Collection</Link>
                    <Link to="/custom-order" className="btn border-2 border-white hover:bg-white hover:text-[#6D4C41]">Custom Order</Link>
                </div>
            </div>
        </div>
    </section>
...
const SpecialCollectionsPreview = () => {
    const navigate = useNavigate();
    const collections = [
        { name: 'Executive Collection', tag: 'New', img: 'https://images.unsplash.com/photo-1593030103066-0093718efeb9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
        { name: 'Limited Edition', tag: 'Limited', img: 'https://images.unsplash.com/photo-1505022610485-0249ba5b3675?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
        { name: 'Weekend Wear', tag: 'Casual', img: 'https://images.unsplash.com/photo-1618932260643-eee4a2f652a6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
    ];
    return (
            ...
            <div className="container mx-auto px-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 ...
                 <div className="text-center mt-12">
                    <button onClick={() => navigate('/special-collections')} className="btn bg-[#6D4C41] hover:bg-[#4E342E] text-white">Lihat Semua Koleksi</button>
                </div>
            </div>
        </section>
    );
        ...
        <section className="py-20 bg-[#F5F5F5]">
            <div className="container mx-auto px-5 grid md:grid-cols-2 gap-10">
                <div className="text-center bg-white p-8 rounded-lg shadow-lg">
                     ...
                     <button onClick={() => navigate('/custom-order')} className="btn bg-[#6D4C41] hover:bg-[#4E342E] text-white">Buat Pesanan Kustom</button>
                </div>
                 <div className="text-center bg-white p-8 rounded-lg shadow-lg">
                     ...
                     <button onClick={() => navigate('/bulk-purchase')} className="btn bg-[#6D4C41] hover:bg-[#4E342E] text-white">Hubungi Tim Bisnis</button>
                </div>
            </div>
        </section>
    );
